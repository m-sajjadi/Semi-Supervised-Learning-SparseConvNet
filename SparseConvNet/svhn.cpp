...
// Total number of training samples: 73257
int n_labeled = 730;
int nt = 5;
...
int main() {
  ...
  SpatiallySparseDataset trainSet = SVHNTrainSet();
  SpatiallySparseDataset testSet = SVHNTestSet();
